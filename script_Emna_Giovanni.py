...
def generate_simple_sparse_tridiagonal_matrix(n, diagonal_value=4 , off_diagonal_value=-1):
    """
...
def generate_sparse_tridiagonal_matrix(n):
    ...
    Returns:
        ...
        b: Right-hand side vector (numpy array).
    """
    return generate_simple_sparse_tridiagonal_matrix(n,4,-1)
...
for n in taille:
    ...
    xSOR, iterSOR, time_takenSOR, errorsSOR = SOR_sparse_with_error(A_sparse,b_h,x0,x_exact,1.8)
...
print(f"Temps pour Jacobi : {time_takenJS}")
print(f"Temps pour GS : {time_takenGS}")
print(f"Temps pour SOR : {time_takenSOR}")